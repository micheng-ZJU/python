...
def do_form(name, the_inputs, method="POST",text="Submit"):
    ...
    return(form.substitute(cgi_name=name, http_method=method, list_of_inputs=inputs, button_text=text))


def radio_button_id(rb_name, rb_value, rb_id):
    return('<input type="radio" name="'+rb_name+'" value="'+rb_id+'">'+rb_value+'<br />')